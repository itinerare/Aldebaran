...
{!! breadcrumbs(['Admin Panel' => 'admin', ucfirst($commission->type->category->type).' Commission Queue' => 'admin/commissions/'.$commission->type->category->type.'/pending', 'Commission (#'.$commission->id.')' => 'admin/commissions/edit/'.$commission->id]) !!}
