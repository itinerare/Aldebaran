...
@section('admin-title') Changelog @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Changelog' => 'admin/changelog', ($log->id ? 'Edit' : 'Create').' Entry' => $log->id ? 'admin/changelog/edit/'.$log->id : 'admin/changelog/create']) !!}
