@if ($project)
    ...
    <p>You are about to delete the project <strong>{{ $project->name }}</strong>. This is not reversible. If pieces in
        this project exist, you will not be able to delete this project.</p>
