...
@section('admin-title') Projects @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Projects' => 'admin/data/projects', ($project->id ? 'Edit' : 'Create').' Project' => $project->id ? 'admin/data/projects/edit/'.$project->id : 'admin/data/projects/create']) !!}
...
<div class="form-group">
    {!! Form::checkbox('is_visible', 1, $project->id ? $project->is_visible : 1, ['class' => 'form-check-input', 'data-toggle' => 'toggle']) !!}
...
$( document ).ready(function() {
    $('.delete-project-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/data/projects/delete') }}/{{ $project->id }}", 'Delete Project');
    });
});
