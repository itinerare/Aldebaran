...
@section('admin-title') Piece @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Pieces' => 'admin/data/pieces', ($piece->id ? 'Edit' : 'Create').' Piece' => $piece->id ? 'admin/data/pieces/edit/'.$piece->id : 'admin/data/pieces/create']) !!}
...
<div class="form-group">
    {!! Form::checkbox('is_visible', 1, $piece->id ? $piece->is_visible : 1, ['class' => 'form-check-input', 'data-toggle' => 'toggle']) !!}
...
@if($piece->id)
    ...
    <div class="text-right">
        <a href="{{ url('admin/data/pieces/images/create/'.$piece->id) }}" class="btn btn-outline-primary mb-2">Add an Image</a>
    </div>
