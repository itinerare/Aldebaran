...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'Tags' => 'admin/data/tags',
        ($tag->id ? 'Edit' : 'Create') . ' Tag' => $tag->id ? 'admin/data/tags/edit/' . $tag->id : 'admin/data/tags/create',
    ]) !!}
    ...
    <div class="row">
        <div class="col-md">
            <div class="form-group">
                {!! Form::checkbox('is_visible', 1, $tag->id ? $tag->is_visible : 1, [
        ...
        <div class="col-md">
            <div class="form-group">
                {!! Form::checkbox('is_active', 1, $tag->id ? $tag->is_active : 1, [
                    'class' => 'form-check-input',
                    'data-toggle' => 'toggle',
                ]) !!}
