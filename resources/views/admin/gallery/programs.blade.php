...
@section('admin-content')
    ...
    <div class="text-right mb-3"><a class="btn btn-primary" href="{{ url('admin/data/programs/create') }}"><i
                class="fas fa-plus"></i> Add New Media/Program</a></div>
        ...
        <div class="row ml-md-2 mb-4">
            ...
            @foreach ($programs as $program)
                <div class="d-flex row flex-wrap col-12 mt-1 pt-2 px-0 ubt-top">
                    ...
                    <div class="col-md-2">{!! $program->has_image
                        ? '<img class="mw-100" style="max-height:25px;" src="' .
                            $program->imageUrl .
                            '" alt="Icon for ' .
                            $program->name .
                            '" />'
                    ...
                    <div class="col-3 col-md-1 text-right">
                        <a href="{{ url('admin/data/programs/edit/' . $program->id) }}"
