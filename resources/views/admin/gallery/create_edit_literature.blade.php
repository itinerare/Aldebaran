...
@section('admin-title') {{ $literature->id ? 'Edit' : 'Create' }} Literature @endsection

@section('admin-content')
{!! breadcrumbs(['Admin Panel' => 'admin', 'Pieces' => 'admin/data/pieces', 'Edit Piece' => 'admin/data/pieces/edit/'.$piece->id, ($literature->id ? 'Edit' : 'Create').' Literature' => $literature->id ? 'admin/data/pieces/literatures/edit/'.$literature->id : 'admin/data/pieces/literatures/create/'.$piece->id]) !!}
...
<p>If set, this will be shown in lieu of a preview of the text in the gallery and other places where thumbnails are displayed.</p>
...
$( document ).ready(function() {
    $('.delete-literature-button').on('click', function(e) {
        e.preventDefault();
        loadModal("{{ url('admin/data/pieces/literatures/delete') }}/{{ $literature->id }}", 'Delete Literature');
    });0.
});
