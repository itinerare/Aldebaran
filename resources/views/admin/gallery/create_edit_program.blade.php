...
@section('admin-content')
    ...
    {!! Form::open([
        'url' => $program->id ? 'admin/data/programs/edit/' . $program->id : 'admin/data/programs/create',
        'files' => true,
    ]) !!}
    ...
    <div class="form-group">
        {!! Form::checkbox('is_visible', 1, $program->id ? $program->is_visible : 1, [
    ...
    <script>
        $(document).ready(function() {
            $('.delete-program-button').on('click', function(e) {
                e.preventDefault();
                loadModal("{{ url('admin/data/programs/delete') }}/{{ $program->id }}",
                    'Delete Program');
            });
        });
    </script>
