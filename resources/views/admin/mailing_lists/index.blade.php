                    ...
                    <div class="col-6 col-md-2">
                        ...
                        {!! $list->subscribers()->verified(0)->count()
                            ? ' <span class="text-muted">(' .
                                ...
                                ' Unverified)</span>'
                            : '' !!}</div>
                    <div class="col-6 col-md-3">{!! $list->entries->count() ? $list->entries->sortByDesc('sent_at')->first()->subject . ' - ' . pretty_date($list->entries->sortByDesc('sent_at')->first()->sent_at) : 'None!' !!}</div>
