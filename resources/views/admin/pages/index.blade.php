...
@section('admin-content')
    ...
    <p>This is a list of text pages used at various places around the site. They are not inherently visible/accessible,
        instead being manually routed to or incorporated into a larger page, i.e. alongside automated components. Rather,
        their inclusion here is to facilitate ease of editing and track when they were last updated.</p>
