        ...
        <div class="row">
            <div class="col-md">
                <div class="form-group">
                    ...
                    {!! Form::text('field_key[]', $key, ['class' => 'form-control', 'placeholder' => 'Internal key. Can\'t be duplicated', 'required']) !!}
                </div>
            </div>
            <div class="col-md">
                <div class="form-group">
                    {!! Form::label('field_type[]', 'Field Type') !!}
                    {!! Form::select('field_type[]', $fieldTypes, $field['type'], ['class' => 'form-control form-field-type', 'placeholder' => 'Select a Type', 'required']) !!}
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    {!! Form::label('field_label[]', 'Field Label') !!}
                    {!! Form::text('field_label[]', $field['label'], ['class' => 'form-control', 'placeholder' => 'Label shown on the commission form', 'required']) !!}
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('field_help[]', isset($field['help']) ? $field['help'] : null, ['class' => 'form-control', 'placeholder' => 'Help tooltip text']) !!}
                </div>
            </div>
        </div>
    </div>
