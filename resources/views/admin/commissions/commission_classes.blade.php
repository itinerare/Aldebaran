...
@section('admin-content')
    ...
    <div class="text-right mb-3"><a class="btn btn-primary" href="{{ url('admin/data/commission-classes/create') }}"><i
                class="fas fa-plus"></i> Create New Class</a></div>
    @if (!count($classes))
            ...
            <tbody id="sortable" class="sortable">
                @foreach ($classes as $class)
                    <tr class="sort-item" data-id="{{ $class->id }}">
                        ...
                        <td class="text-right">
                            <a href="{{ url('admin/data/commission-classes/edit/' . $class->id) }}"
