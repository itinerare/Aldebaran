        ...
        <div class="row">
            <div class="col-md">
                <div class="form-group">
                    ...
                    {!! Form::text('field_key[]', null, ['class' => 'form-control', 'placeholder' => 'Internal key. Can\'t be duplicated in a form']) !!}
                </div>
            </div>
            <div class="col-md">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('field_label[]', null, ['class' => 'form-control', 'placeholder' => 'Label shown on the commission form']) !!}
                </div>
            </div>
