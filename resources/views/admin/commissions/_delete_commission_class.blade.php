@if($class)
    ...
    <p>You are about to delete the class <strong>{{ $class->name }}</strong>. This is not reversible. If commission categories in this class exist, you will not be able to delete this class.</p>
