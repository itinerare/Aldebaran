            ...
            <tbody id="sortable" class="sortable">
                @foreach ($types as $type)
                    <tr class="sort-item" data-id="{{ $type->id }}">
                        ...
                        <td class="text-right">
                            <a href="{{ url('admin/commissions/new/' . $type->id) }}" class="btn btn-primary py-0 px-2"
                                data-toggle="tooltip" title="Manually create a new commission of this type.">New</a>
                            <a href="{{ url('admin/data/commission-types/edit/' . $type->id) }}"
