<div class="{{ Config::get('itinerare.settings.gallery_arrangement') == 'rows' ? 'flex-fill' : '' }} img-fluid align-self-center text-center m-1">
    <div class="container">
        <div class="content align-self-center" style="min-height:100px;">
            ...
            <a class="align-self-center" href="{{ $piece->url.'?source='.$source }}">
                ...
                <div class="text-center align-self-center">
                    <img src="{{ $piece->thumbnailUrl }}" style="{{ Config::get('itinerare.settings.gallery_arrangement') == 'rows' ? 'width: auto; height: '.Config::get('itinerare.settings.thumbnail_height').'px' : 'height: auto; max-width: '.Config::get('itinerare.settings.thumbnail_width').'px' }}" />
                </div>
