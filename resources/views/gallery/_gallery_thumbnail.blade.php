<div class="{{ Config::get('ars.settings.gallery_arrangement') == 'rows' ? 'flex-fill' : '' }} img-fluid align-self-center text-center m-1">
    <div class="container">
        <div class="content align-self-center" style="min-height:100px;">
            ...
            <a class="align-self-center" href="{{ $piece->url.'?source='.$source }}">
                ...
                <div class="text-center align-self-center">
                    <img src="{{ $piece->thumbnailUrl }}" style="{{ Config::get('ars.settings.gallery_arrangement') == 'rows' ? 'width: auto; height: '.Config::get('ars.settings.thumbnail_height').'px' : 'height: auto; max-width: '.Config::get('ars.settings.thumbnail_width').'px' }}" />
                </div>
