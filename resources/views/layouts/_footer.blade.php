...
<div class="copyright">
    &copy; {{ Settings::get('site_name') }} {{ Carbon\Carbon::now()->year }} ・ <a href="https://code.itinerare.net/itinerare/Aldebaran">Aldebaran v{{ config('aldebaran.settings.version') }}</a> ・ <a href="{{ url('changelog') }}">Changelog</a> ・ <a
