<p>{{ $commission->commissioner->email }} has submitted a new request for a {{ $commission->type->name }}
    {{ $commission->type->category->name }} ({{ $commission->type->category->class->name }}) commission. <a
        href="{{ url('admin/commissions/edit/' . $commission->id) }}">Click here to view information about this
        request</a>.<br />
...
<p>There are currently
    ...
    in the {{ $commission->type->category->class->name }} queue. <a
        href="{{ url('admin/commissions/' . $commission->type->category->class->slug) }}">Click here to view the
        queue</a>.</p>
