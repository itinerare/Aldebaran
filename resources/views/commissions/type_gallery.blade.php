...
@if($pieces->count())
    ...
    @include('gallery._flex_'.Config::get('itinerare.settings.gallery_arrangement'), ['pieces' => $pieces, 'source' => 'commissions/types/'.(isset($source) && $source == 'key' ? $type->key : $type->id).'/gallery'])
