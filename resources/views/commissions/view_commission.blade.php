    ...
    <div class="borderhr">
        <div class="col-md">
            ...
            <div class="row">
                ...
                <div class="col-md">{!! $commission->isPaid !!}{{ isset($commission->costData) && $commission->costData ? ($commission->status == 'Accepted' ? (!$commission->paid_status ? ' - You will be notified and sent an invoice when I am ready to begin work. Please pay promptly!' : '') : ($commission->status != 'Complete' ? ' - Payment is only collected for accepted commissions.' : '')) : '' }}</div>
            </div>
            <div class="row">
