...
Note that while the project is primarily located at https://code.itinerare.net/itinerare/Aldebaran, contributions are accepted via [GitHub](https://github.com/itinerare/Aldebaran) for convenience.
